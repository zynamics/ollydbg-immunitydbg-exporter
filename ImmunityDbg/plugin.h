...
#define AddRowHeader                  _AddRowHeader                
#define Addhookz                      _Addhookz                    
#define Addsorteddata                 _Addsorteddata               
#define Addtolist                     _Addtolist                   
#define Analysecode                   _Analysecode                 
#define Animate                       _Animate                     
#define Arefgettext                   _Arefgettext                 
#define Areggettext                   _Areggettext                 
#define Assemble                      _Assemble                    
#define Attachtoactiveprocess         _Attachtoactiveprocess       
#define Broadcast                     _Broadcast                   
#define Browsefilename                _Browsefilename              
#define Calculatecrc                  _Calculatecrc                
#define Checkcondition                _Checkcondition              
#define Compress                      _Compress                    
#define Createdumpwindow              _Createdumpwindow            
#define Createlistwindow              _Createlistwindow            
#define Createpatchwindow             _Createpatchwindow           
#define Createprofilewindow           _Createprofilewindow         
#define Creatertracewindow            _Creatertracewindow          
#define Createsorteddata              _Createsorteddata            
#define Createthreadwindow            _Createthreadwindow          
#define Createwatchwindow             _Createwatchwindow           
#define Createwinwindow               _Createwinwindow             
#define Decodeaddress                 _Decodeaddress               
#define Decodeascii                   _Decodeascii                 
#define Decodecharacter               _Decodecharacter             
#define Decodefullvarname             _Decodefullvarname           
#define Decodeknownargument           _Decodeknownargument         
#define Decodename                    _Decodename                  
#define Decoderange                   _Decoderange                 
#define Decoderelativeoffset          _Decoderelativeoffset        
#define Decodethreadname              _Decodethreadname            
#define Decodeunicode                 _Decodeunicode               
#define Decompress                    _Decompress                  
#define Defaultbar                    _Defaultbar                  
#define Deletebreakpoints             _Deletebreakpoints           
#define Deletehardwarebreakbyaddr     _Deletehardwarebreakbyaddr   
#define Deletehardwarebreakpoint      _Deletehardwarebreakpoint    
#define Deletenamerange               _Deletenamerange             
#define Deletenonconfirmedsorteddata  _Deletenonconfirmedsorteddata
#define Deleteruntrace                _Deleteruntrace              
#define Deletesorteddata              _Deletesorteddata            
#define Deletesorteddatarange         _Deletesorteddatarange       
#define Deletewatch                   _Deletewatch                 
#define Demanglename                  _Demanglename                
#define Destroysorteddata             _Destroysorteddata           
#define Disasm                        _Disasm                      
#define Disassembleback               _Disassembleback             
#define Disassembleforward            _Disassembleforward          
#define Discardquicknames             _Discardquicknames           
#define Dumpbackup                    _Dumpbackup                  
#define Error                         _Error                       
#define Executehooktimeout            _Executehooktimeout          
#define Expression                    _Expression                  
#define Findallcommands               _Findallcommands             
#define Findalldllcalls               _Findalldllcalls             
#define Findallsequences              _Findallsequences            
#define Finddecode                    _Finddecode                  
#define Findfileoffset                _Findfileoffset              
#define Findfixup                     _Findfixup                   
#define Findhittrace                  _Findhittrace                
#define Findimportbyname              _Findimportbyname            
#define Findlabel                     _Findlabel                   
#define Findlabelbyname               _Findlabelbyname             
#define Findmemory                    _Findmemory                  
#define Findmodule                    _Findmodule                  
#define Findname                      _Findname                    
#define Findnextname                  _Findnextname                
#define Findnextproc                  _Findnextproc                
#define Findnextruntraceip            _Findnextruntraceip          
#define Findprevproc                  _Findprevproc                
#define Findprevruntraceip            _Findprevruntraceip          
#define Findprocbegin                 _Findprocbegin               
#define Findprocend                   _Findprocend                 
#define Findreferences                _Findreferences              
...
#define Findstrings                   _Findstrings                 
#define Findsymbolicname              _Findsymbolicname            
#define Findthread                    _Findthread                  
#define Findunknownfunction           _Findunknownfunction         
#define Flash                         _Flash                       
#define Followcall                    _Followcall                  
#define Get3dnow                      _Get3dnow                    
#define Get3dnowxy                    _Get3dnowxy                  
#define Getaddressfromline            _Getaddressfromline          
#define Getasmfindmodel               _Getasmfindmodel             
#define Getasmfindmodelxy             _Getasmfindmodelxy           
#define Getbprelname                  _Getbprelname                
#define Getbreakpointtype             _Getbreakpointtype           
#define Getbreakpointtypecount        _Getbreakpointtypecount      
#define Getcputhreadid                _Getcputhreadid              
#define Getdisassemblerrange          _Getdisassemblerrange        
#define Getfloat                      _Getfloat                    
#define Getfloat10                    _Getfloat10                  
#define Getfloat10xy                  _Getfloat10xy                
#define Getfloatxy                    _Getfloatxy                  
#define Gethexstring                  _Gethexstring                
#define Gethexstringxy                _Gethexstringxy              
#define Getline                       _Getline                     
#define Getlinefromaddress            _Getlinefromaddress          
#define Getlinexy                     _Getlinexy                   
#define Getlong                       _Getlong                     
#define Getlongxy                     _Getlongxy                   
#define Getmmx                        _Getmmx                      
#define Getmmxxy                      _Getmmxxy                    
#define Getnextbreakpoint             _Getnextbreakpoint           
#define Getoriginaldatasize           _Getoriginaldatasize         
#define Getproclimits                 _Getproclimits               
#define Getregisters                  _Getregisters                
#define Getregxy                      _Getregxy                    
#define Getresourcestring             _Getresourcestring           
#define Getruntraceprofile            _Getruntraceprofile          
#define Getruntraceregisters          _Getruntraceregisters        
#define Getsortedbyselection          _Getsortedbyselection        
#define Getsourcefilelimits           _Getsourcefilelimits         
#define Getstatus                     _Getstatus                   
#define Gettableselectionxy           _Gettableselectionxy         
#define Gettext                       _Gettext                     
#define Gettextxy                     _Gettextxy                   
#define Getwatch                      _Getwatch                    
#define Go                            _Go                          
#define GraphAdd                      _GraphAdd                    
#define Guardmemory                   _Guardmemory                 
#define Hardbreakpoints               _Hardbreakpoints             
#define Havecopyofmemory              _Havecopyofmemory            
#define Infoline                      _Infoline                    
#define Injectcode                    _Injectcode                  
#define Insertname                    _Insertname                  
#define Insertwatch                   _Insertwatch                 
#define Isfilling                     _Isfilling                   
#define Isprefix                      _Isprefix                    
#define Isretaddr                     _Isretaddr                   
#define Issuspicious                  _Issuspicious                
#define IstextA                       _IstextA                     
#define IstextW                       _IstextW                     
#define Listhook                      _Listhook                    
#define Listmemory                    _Listmemory                  
#define LoopTicking                   _LoopTicking                 
#define Manualbreakpoint              _Manualbreakpoint            
#define Mergequicknames               _Mergequicknames             
#define Message                       _Message                     
#define Modifyhittrace                _Modifyhittrace              
#define Newtablewindow                _Newtablewindow              
#define OpenEXEfile                   _OpenEXEfile                 
#define Painttable                    _Painttable                  
...
#define Pluginsaverecord              _Pluginsaverecord            
#define Pluginwriteinttoini           _Pluginwriteinttoini         
#define Pluginwritestringtoini        _Pluginwritestringtoini      
#define Prepareasmseq                 _Prepareasmseq               
#define Preparefornewprocess          _Preparefornewprocess        
#define Print3dnow                    _Print3dnow                  
#define Printfloat10                  _Printfloat10                
#define Printfloat4                   _Printfloat4                 
#define Printfloat8                   _Printfloat8                 
#define Printsse                      _Printsse                    
#define Progress                      _Progress                    
#define PyCommitKnowledge             _PyCommitKnowledge           
#define PyDettach                     _PyDettach                   
#define PyExitID                      _PyExitID                    
#define PyFindDataRef                 _PyFindDataRef               
#define PyFindStrings                 _PyFindStrings               
#define PyGetUDDKnowledge             _PyGetUDDKnowledge           
#define PyGetallbasicblocks           _PyGetallbasicblocks         
#define PyGo                          _PyGo                        
#define PyGoSilent                    _PyGoSilent                  
#define PyIgnoreSingleStep            _PyIgnoreSingleStep          
#define PyShowgraph                   _PyShowgraph                 
#define Py_run                        _Py_run                      
#define Pyaddknowledge                _Pyaddknowledge              
#define Pycmdexec                     _Pycmdexec                   
#define Pycombo                       _Pycombo                     
#define Pycreategraphwindow           _Pycreategraphwindow         
#define Pyforgetknowledge             _Pyforgetknowledge           
#define Pygetallhandles               _Pygetallhandles             
#define Pygetallnames                 _Pygetallnames               
#define Pygetcallstack                _Pygetcallstack              
#define Pygetcalltree                 _Pygetcalltree               
#define Pygetevent                    _Pygetevent                  
#define Pygetintercall                _Pygetintercall              
#define Pygetknowledge                _Pygetknowledge              
#define Pygetpanelinfo                _Pygetpanelinfo              
#define Pygetsehchain                 _Pygetsehchain               
#define Pygetthreadid                 _Pygetthreadid               
#define Pyinput                       _Pyinput                     
#define Pylistknowledge               _Pylistknowledge             
#define Pyps                          _Pyps                        
#define Pysetreg                      _Pysetreg                    
#define Pyshowtextwindow              _Pyshowtextwindow            
#define Pythonsearch                  _Pythonsearch                
#define Quickinsertname               _Quickinsertname             
#define Quicktablewindow              _Quicktablewindow            
#define Readcommand                   _Readcommand                 
#define Readmemory                    _Readmemory                  
#define Redrawdisassembler            _Redrawdisassembler          
#define Registerotclass               _Registerotclass             
#define Registerpluginclass           _Registerpluginclass         
#define Removehook                    _Removehook                  
#define Restoreallthreads             _Restoreallthreads           
#define Runsinglethread               _Runsinglethread             
#define Runtracesize                  _Runtracesize                
#define Scanmodules                   _Scanmodules                 
#define Scrollruntracewindow          _Scrollruntracewindow        
#define Selectandscroll               _Selectandscroll             
#define Sendshortcut                  _Sendshortcut                
#define Setbreakpoint                 _Setbreakpoint               
#define Setbreakpointext              _Setbreakpointext            
#define Setcpu                        _Setcpu                      
#define Setdisasm                     _Setdisasm                   
#define Setdumptype                   _Setdumptype                 
#define Sethardwarebreakpoint         _Sethardwarebreakpoint       
#define Setmembreakpoint              _Setmembreakpoint            
#define Setstatus                     _Setstatus                   
#define Settracecondition             _Settracecondition           
#define Settracecount                 _Settracecount               
#define Settracepauseoncommands       _Settracepauseoncommands     
#define Showsourcefromaddress         _Showsourcefromaddress       
#define Simpleassemble                _Simpleassemble              
#define Sortsorteddata                _Sortsorteddata              
#define Startruntrace                 _Startruntrace               
#define Stringtotext                  _Stringtotext                
#define Suspendprocess                _Suspendprocess              
#define Tablefunction                 _Tablefunction               
#define Tempbreakpoint                _Tempbreakpoint              
#define Unregisterpluginclass         _Unregisterpluginclass       
#define Updateallcpu                  _Updateallcpu                
#define Updatelist                    _Updatelist                  
#define Vcgcore                       _Vcgcore                     
#define Walkreference                 _Walkreference               
#define Walkreferenceex               _Walkreferenceex             
#define Writememory                   _Writememory                 
#define _GetExceptDLLinfo             __GetExceptDLLinfo           
#define __CPPdebugHook                ___CPPdebugHook              
#define checkvmWare                   _checkvmWare                 
#define pygetdebuggedname             _pygetdebuggedname           
#define pygetpythread                 _pygetpythread 
